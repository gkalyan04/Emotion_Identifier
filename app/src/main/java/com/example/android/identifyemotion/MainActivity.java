package com.example.android.identifyemotion;
...
public class MainActivity extends AppCompatActivity {
    ...
    public EmotionServiceClient restClient = new EmotionServiceRestClient("09a205506fa948f79a416df5c1048f0d");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(checkSelfPermission(android.Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED && checkSelfPermission(android.Manifest.permission.WRITE_CONTACTS) != PackageManager.PERMISSION_GRANTED)
        {
    ...
    private void processImage(){
        ...
        AsyncTask<InputStream,String,List<RecognizeResult>> processAsync = new AsyncTask<InputStream, String, List<RecognizeResult>>() {
            ...
            @Override
            protected void onProgressUpdate(String... values) {mDialog.setMessage(values[0]);}
